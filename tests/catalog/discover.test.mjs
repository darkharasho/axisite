...
import { QUERIES, SEEDS, discover, isGeneratedReportRepo, isPublishable } from '../../scripts/catalog/discover.mjs'

vi.mock('../../scripts/catalog/github.mjs', () => ({
...
describe('the axi suite seeds', () => {
  ...
  it('does not spend a call on a seed the search already found', async () => {
    const { ghFetch } = await import('../../scripts/catalog/github.mjs')
    ghFetch.mockClear()
